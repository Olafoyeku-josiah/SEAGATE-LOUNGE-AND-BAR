...
export function DeliverySection() {
  return (
    <section id="delivery" className="py-20 bg-slate-100/80 relative">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <Card className="border-slate-200 bg-white p-8 sm:p-12 shadow-lg relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            {/* Left Info */}
            <div className="lg:col-span-7 space-y-6">
              <div className="flex items-center gap-2">
                <Badge variant="default" className="px-4 py-1 text-xs uppercase tracking-wider bg-slate-900 text-white border-0">
                  <Truck className="mr-1.5 h-4 w-4" /> Doorstep Delivery
                </Badge>
                <Badge variant="outline" className="text-slate-700 border-slate-300 bg-white">
                  <Clock className="mr-1 h-3.5 w-3.5 text-slate-600" /> Fast & Reliable
                </Badge>
              </div>

              <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-slate-900 leading-tight">
                HOME DELIVERY AVAILABLE <br />
                <span className="text-slate-700">WE DELIVER TO YOU!</span>
              </h2>
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+2347047784064" className="w-full sm:w-auto">
                  <Button variant="outline" size="lg" className="w-full">
                    <PhoneCall className="mr-2 h-5 w-5 text-slate-700" /> Call to Order
                  </Button>
                </a>
              </div>
            </div>
            ...
            {/* Right Contact Card */}
            <div className="lg:col-span-5 bg-slate-900 rounded-3xl p-6 border border-slate-800 text-center space-y-6 shadow-xl text-white">
